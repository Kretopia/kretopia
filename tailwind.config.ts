...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        "credits-drift": "credits-drift 14s ease-in-out infinite",
        "credits-drift-slow": "credits-drift-slow 20s ease-in-out infinite",
        "credits-scan": "credits-scan 9s linear infinite",
