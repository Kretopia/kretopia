    ...
    <Sheet open={open} onOpenChange={(o) => { setOpen(o); if (o) loadAll(); }}>
      <SheetTrigger asChild>
        <button
          ...
          title="What Thrive remembers about this Studio"
        >
      ...
      <SheetContent side="right" className="w-full sm:max-w-md overflow-y-auto pt-[max(env(safe-area-inset-top),0.5rem)]">
        <SheetHeader>
          ...
          <p className="text-xs text-muted-foreground text-left">
            Everything Thrive remembers from what you've dropped here. Used automatically when you ask for decks, proposals, invoices.
          </p>
        </SheetHeader>
