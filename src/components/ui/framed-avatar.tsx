...
const frameStyles: Record<string, string> = {
  ...
  gradient_rainbow:
    "ring-[3px] ring-transparent bg-clip-padding [background-image:linear-gradient(var(--background),var(--background)),var(--kretopia-sunset,linear-gradient(135deg,#9413D2,#E0179C))] [background-origin:border-box] [background-clip:padding-box,border-box]",
  pulse_primary:
