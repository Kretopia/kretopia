...
import { Search, Send, Target } from "lucide-react";
  ...
  return (
    <div className="container mx-auto px-4 py-4 max-w-4xl pb-24 md:pb-4">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h1 className="text-xl font-bold">Sales Tools</h1>
          <p className="text-xs text-muted-foreground">Find leads & automate outreach</p>
        </div>
      </div>
