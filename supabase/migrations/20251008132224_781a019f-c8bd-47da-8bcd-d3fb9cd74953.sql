-- Fix handle_new_user to properly set company account_type
...
BEGIN
  ...
  -- Handle both 'company' and 'individual' strings from metadata
  ...
  -- Set appropriate default role based on account type
  ...
  VALUES (
    ...
    'New User',
    CASE 
      WHEN user_account_type = 'company' THEN 'Company'
      ELSE 'Creator'
    END,
    10,
    num_invites,
