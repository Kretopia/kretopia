-- Update handle_new_user to not set full_name and role (collected in onboarding)
...
BEGIN
  ...
  VALUES (
    new.id,
    'New User',  -- Placeholder, will be updated in onboarding
    'Creator',   -- Placeholder, will be updated in onboarding
    10,
    num_invites,
    invite_badge,
