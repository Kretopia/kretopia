...
const CATEGORY_CARDS = [
  { value: "music", emoji: "", label: "Music & Audio", gradient: "from-primary/20 to-fuchsia-500/20" },
  ...
  { value: "photography", emoji: "", label: "Photography", gradient: "from-primary/20 to-primary/20" },
