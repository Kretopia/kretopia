...
const CATEGORY_CARDS = [
  ...
  { value: "design", emoji: "🎨", label: "Design", gradient: "from-pink-500/20 to-rose-500/20" },
  ...
  { value: "education", emoji: "📚", label: "Courses", gradient: "from-indigo-500/20 to-purple-500/20" },
];
