  ...
  <div className="flex flex-col items-center justify-center h-full bg-gradient-to-br from-[#0d0d1a] via-[#1a1030] to-[#0d0d1a] text-white px-20">
    ...
    <div className="relative z-10 text-center space-y-12">
      ...
      <div className="flex items-center gap-6 justify-center mt-8">
        <span className="px-8 py-3 rounded-full border border-indigo-600/40 text-[24px] text-purple-300 font-medium">
  ...
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-16">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-indigo-500 font-semibold">The Thesis</p>
        <h2 className="text-[64px] font-bold leading-[1.1] max-w-[1400px]">
          Creative work is global.<br />
          <span className="text-indigo-500">Its infrastructure is broken.</span>
        </h2>
      </div>
      <div className="grid grid-cols-2 gap-12 max-w-[1500px]">
        ...
        <div className="flex items-center">
          <div className="p-10 rounded-3xl border border-indigo-600/20 bg-indigo-600/5 backdrop-blur">
...
const Slide3 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-indigo-500 font-semibold">The Problem</p>
...
const Slide4 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-indigo-500 font-semibold">The Solution</p>
        <h2 className="text-[56px] font-bold">One Vertical <span className="text-indigo-500">Operating System</span></h2>
...
const Slide5 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      ...
      <div className="p-6 rounded-2xl bg-indigo-600/10 border border-indigo-600/20 text-center">
...
const Slide6 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-indigo-500 font-semibold">Unfair Advantage</p>
        <h2 className="text-[52px] font-bold leading-tight">
          Most marketplaces die from cold start.<br />
          <span className="text-indigo-500">We launch into density.</span>
        </h2>
      </div>
      <div className="grid grid-cols-2 gap-16">
        <div className="space-y-6">
          ...
          {[
            ...
            <div key={i} className="flex items-start gap-4">
              <div className="w-2 h-2 rounded-full bg-indigo-500 mt-3 shrink-0" />
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-center gap-4 p-5 rounded-xl bg-white/5">
                ...
                <span className="text-indigo-500 text-[24px]">→</span>
                <span className="text-[24px] text-purple-300">{item.to}</span>
              </div>
            ))}
          </div>
          <div className="mt-8 p-6 rounded-2xl bg-indigo-600/10 border border-indigo-600/20">
...
const Slide7 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-indigo-500 font-semibold">Strategy</p>
        <h2 className="text-[56px] font-bold">
          Dominate hubs. <span className="text-indigo-500">Then expand.</span>
        </h2>
      </div>
      <div className="grid grid-cols-3 gap-10">
        {[
          ...
          <div key={i} className={`p-10 rounded-3xl border ${item.status === 'active' ? 'border-indigo-600/40 bg-indigo-600/10' : 'border-white/10 bg-white/5'} space-y-6`}>
            <span className="text-[64px]">{item.emoji}</span>
            <div>
              <p className="text-[20px] text-indigo-500 font-semibold uppercase tracking-wider">{item.phase}</p>
...
const Slide8 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-indigo-500 font-semibold">Business Model</p>
        <h2 className="text-[56px] font-bold">
...
const Slide9 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-indigo-500 font-semibold">Go-to-Market</p>
        <h2 className="text-[56px] font-bold">
          <span className="text-indigo-500">Event-Led</span> Growth
        </h2>
      </div>
      <div className="grid grid-cols-2 gap-16">
        <div className="space-y-10">
          <div className="p-10 rounded-3xl bg-gradient-to-br from-indigo-600/20 to-fuchsia-500/10 border border-indigo-600/30">
        ...
        <div className="space-y-8">
          ...
          {[
            ...
            <div key={i} className="flex items-start gap-5">
              <div className="w-8 h-8 rounded-lg bg-indigo-600/20 flex items-center justify-center text-indigo-500 font-bold text-[18px] shrink-0">{i + 1}</div>
...
const Slide10 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-indigo-500 font-semibold">Traction & Projections</p>
        <h2 className="text-[56px] font-bold">
      ...
      <div className="grid grid-cols-3 gap-10">
        {[
          ...
          <div key={i} className={`p-10 rounded-3xl border ${item.highlight ? 'border-green-500/40 bg-green-500/10' : 'border-white/10 bg-white/5'} space-y-8`}>
            <p className="text-[22px] text-indigo-500 font-semibold uppercase tracking-wider">{item.period}</p>
            <div className="space-y-6">
              <div>
...
const Slide11 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-indigo-500 font-semibold">Founder</p>
        <h2 className="text-[56px] font-bold">
          Founder-Market <span className="text-indigo-500">Fit</span>
        </h2>
      </div>
      <div className="grid grid-cols-2 gap-16">
        <div className="space-y-8">
        ...
        <div className="flex flex-col justify-between">
          <div className="p-10 rounded-3xl bg-indigo-600/10 border border-indigo-600/20 space-y-6">
...
const Slide12 = () => (
  <div className="flex flex-col justify-center h-full bg-gradient-to-br from-[#0d0d1a] via-[#1a1030] to-[#0d0d1a] text-white px-28 py-20">
    ...
    <div className="relative z-10 grid grid-cols-2 gap-20">
      <div className="space-y-10">
        <div className="space-y-6">
          <p className="text-[20px] uppercase tracking-[6px] text-indigo-500 font-semibold">Vision & The Ask</p>
          <h2 className="text-[52px] font-bold leading-tight">
            The Identity Layer for the <span className="text-indigo-500">Creative World</span>
          </h2>
        </div>
        ...
        <div className="flex gap-6">
          {["Trust", "Transaction history", "Reputation score"].map((item, i) => (
            <div key={i} className="px-6 py-3 rounded-full bg-indigo-600/20 border border-indigo-600/30 text-[20px] text-purple-300 font-medium">
              {item}
            </div>
          ))}
        </div>
      ...
      <div className="flex flex-col justify-center">
        <div className="p-12 rounded-3xl bg-gradient-to-br from-indigo-600/20 to-fuchsia-500/10 border border-indigo-600/30 space-y-10">
          <div className="space-y-4">
          ...
          <div className="w-full h-px bg-indigo-600/30" />
          <div className="space-y-5">
            ...
            {SLIDE_TITLES.map((title, i) => (
              <button
                ...
                className={`w-full text-left p-2 rounded-lg text-xs transition-colors ${
                  i === current
                    ? 'bg-indigo-700/30 border border-indigo-600/50 text-white'
          ...
          {SLIDES.map((_, i) => (
            <button
              ...
              className={`w-2.5 h-2.5 rounded-full transition-colors ${
                i === current ? 'bg-indigo-600' : 'bg-white/20 hover:bg-white/40'
              }`}
            />
          ))}
        </div>
