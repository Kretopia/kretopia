        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-card border border-border/50 rounded-2xl p-6 sm:p-8 hover:border-secondary/30 transition-all h-full">
              ...
              <p className="text-muted-foreground">
                Peers endorse your work. Brands verify you directly. Your ThriveCredits™ profile becomes your verified creative résumé — searchable by anyone hiring.
              </p>
              <div className="mt-4 flex items-center gap-2">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-card border border-border/50 rounded-2xl p-6 sm:p-8 hover:border-accent/30 transition-all h-full">
              ...
              <p className="text-muted-foreground">
                Land gigs, manage projects with milestones, send invoices — and every completed project auto-adds to your ThriveCredits™ history.
              </p>
              <div className="mt-4 flex items-center gap-2">
