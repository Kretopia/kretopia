...
import { LogOut, Menu, Settings, Users, User, Briefcase, MessageCircle, Shield, Crown, Sparkles, DollarSign, FolderKanban, Search, BookOpen, BarChart3, ShoppingBag, Gift, MessageSquareMore } from "lucide-react";
