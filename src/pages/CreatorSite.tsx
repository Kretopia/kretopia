  ...
  useEffect(() => {
    const fetchSiteData = async () => {
      ...
      const { data: profile, error } = await supabase
        .from('profiles')
        .select('user_id, full_name, role, bio, location, avatar_url, cover_image_url, website, calendly_url, linkedin_url, instagram_url, twitter_url, youtube_url, spotify_url, rate_range, site_template, site_enabled, professional_skills, subscription_tier')
        .eq('user_id', userId)
        .maybeSingle();
      ...
      const proTiers = ['pro', 'creator_pro', 'enterprise', 'founder', 'thriver'];
