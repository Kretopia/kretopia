...
const Slide1 = () => (
  <div className="flex flex-col items-center justify-center h-full bg-gradient-to-br from-[#0d0d1a] via-[#1a1030] to-[#0d0d1a] text-white px-20">
    <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
      <div className="absolute top-[15%] left-[10%] w-[500px] h-[500px] rounded-full bg-purple-600/10 blur-[120px]" />
      <div className="absolute bottom-[10%] right-[10%] w-[400px] h-[400px] rounded-full bg-fuchsia-500/8 blur-[100px]" />
    </div>
    <div className="relative z-10 text-center space-y-12">
      <div className="space-y-4">
        <h1 className="text-[120px] font-black tracking-tight leading-none bg-gradient-to-r from-purple-400 via-fuchsia-400 to-purple-300 bg-clip-text text-transparent">
          ThriveIN
        </h1>
        <div className="w-32 h-1 bg-gradient-to-r from-purple-500 to-fuchsia-500 mx-auto rounded-full" />
      </div>
      ...
      <div className="flex items-center gap-6 justify-center mt-8">
        <span className="px-8 py-3 rounded-full border border-purple-500/40 text-[24px] text-purple-300 font-medium">
  ...
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-16">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-purple-400 font-semibold">The Thesis</p>
        <h2 className="text-[64px] font-bold leading-[1.1] max-w-[1400px]">
          Creative work is global.<br />
          <span className="text-purple-400">Its infrastructure is broken.</span>
        </h2>
      </div>
      <div className="grid grid-cols-2 gap-12 max-w-[1500px]">
        <div className="space-y-8">
          <div className="flex items-start gap-5">
            <div className="w-3 h-3 rounded-full bg-purple-500 mt-3 shrink-0" />
        ...
        <div className="flex items-center">
          <div className="p-10 rounded-3xl border border-purple-500/20 bg-purple-500/5 backdrop-blur">
...
const Slide3 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-purple-400 font-semibold">The Problem</p>
...
const Slide4 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-purple-400 font-semibold">The Solution</p>
        <h2 className="text-[56px] font-bold">One Vertical <span className="text-purple-400">Operating System</span></h2>
        <p className="text-[26px] text-white/60">ThriveIN integrates the full creative lifecycle</p>
      </div>
      <div className="grid grid-cols-4 gap-8">
        {[
          { title: "Connect", desc: "AI-powered matching + verified profiles", icon: "🔗", color: "from-purple-500/20 to-purple-600/10" },
...
const Slide6 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-purple-400 font-semibold">Unfair Advantage</p>
        <h2 className="text-[52px] font-bold leading-tight">
          Most marketplaces die from cold start.<br />
          <span className="text-purple-400">We launch into density.</span>
        </h2>
      </div>
      <div className="grid grid-cols-2 gap-16">
        <div className="space-y-6">
          ...
          {[
            ...
            <div key={i} className="flex items-start gap-4">
              <div className="w-2 h-2 rounded-full bg-purple-400 mt-3 shrink-0" />
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-center gap-4 p-5 rounded-xl bg-white/5">
                ...
                <span className="text-purple-400 text-[24px]">→</span>
...
const Slide7 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-purple-400 font-semibold">Strategy</p>
        <h2 className="text-[56px] font-bold">
          Dominate hubs. <span className="text-purple-400">Then expand.</span>
        </h2>
      </div>
      <div className="grid grid-cols-3 gap-10">
        {[
          ...
          <div key={i} className={`p-10 rounded-3xl border ${item.status === 'active' ? 'border-purple-500/40 bg-purple-500/10' : 'border-white/10 bg-white/5'} space-y-6`}>
            <span className="text-[64px]">{item.emoji}</span>
            <div>
              <p className="text-[20px] text-purple-400 font-semibold uppercase tracking-wider">{item.phase}</p>
...
const Slide8 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-purple-400 font-semibold">Business Model</p>
        <h2 className="text-[56px] font-bold">
...
const Slide9 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-purple-400 font-semibold">Go-to-Market</p>
        <h2 className="text-[56px] font-bold">
          <span className="text-purple-400">Event-Led</span> Growth
        </h2>
      </div>
      <div className="grid grid-cols-2 gap-16">
        <div className="space-y-10">
          <div className="p-10 rounded-3xl bg-gradient-to-br from-purple-500/20 to-fuchsia-500/10 border border-purple-500/30">
        ...
        <div className="space-y-8">
          ...
          {[
            ...
            <div key={i} className="flex items-start gap-5">
              <div className="w-8 h-8 rounded-lg bg-purple-500/20 flex items-center justify-center text-purple-400 font-bold text-[18px] shrink-0">{i + 1}</div>
...
const Slide10 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-purple-400 font-semibold">Traction & Projections</p>
        <h2 className="text-[56px] font-bold">
      ...
      <div className="grid grid-cols-3 gap-10">
        {[
          ...
          <div key={i} className={`p-10 rounded-3xl border ${item.highlight ? 'border-green-500/40 bg-green-500/10' : 'border-white/10 bg-white/5'} space-y-8`}>
            <p className="text-[22px] text-purple-400 font-semibold uppercase tracking-wider">{item.period}</p>
            <div className="space-y-6">
              <div>
...
const Slide11 = () => (
  <div className="flex flex-col justify-center h-full bg-[#0d0d1a] text-white px-28 py-20">
    <div className="space-y-14">
      <div className="space-y-6">
        <p className="text-[20px] uppercase tracking-[6px] text-purple-400 font-semibold">Founder</p>
        <h2 className="text-[56px] font-bold">
          Founder-Market <span className="text-purple-400">Fit</span>
        </h2>
      </div>
      <div className="grid grid-cols-2 gap-16">
        <div className="space-y-8">
          <div className="flex items-center gap-8">
            <div className="w-[180px] h-[180px] rounded-3xl bg-gradient-to-br from-purple-500/30 to-fuchsia-500/20 flex items-center justify-center text-[72px]">
              EA
            </div>
            <div>
        ...
        <div className="flex flex-col justify-between">
          <div className="p-10 rounded-3xl bg-purple-500/10 border border-purple-500/20 space-y-6">
...
const Slide12 = () => (
  <div className="flex flex-col justify-center h-full bg-gradient-to-br from-[#0d0d1a] via-[#1a1030] to-[#0d0d1a] text-white px-28 py-20">
    <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
      <div className="absolute top-[20%] right-[15%] w-[600px] h-[600px] rounded-full bg-purple-600/10 blur-[120px]" />
    </div>
    <div className="relative z-10 grid grid-cols-2 gap-20">
      <div className="space-y-10">
        <div className="space-y-6">
          <p className="text-[20px] uppercase tracking-[6px] text-purple-400 font-semibold">Vision & The Ask</p>
          <h2 className="text-[52px] font-bold leading-tight">
            The Identity Layer for the <span className="text-purple-400">Creative World</span>
          </h2>
        </div>
        ...
        <div className="flex gap-6">
          {["Trust", "Transaction history", "Reputation score"].map((item, i) => (
            <div key={i} className="px-6 py-3 rounded-full bg-purple-500/20 border border-purple-500/30 text-[20px] text-purple-300 font-medium">
              {item}
            </div>
          ))}
        </div>
      ...
      <div className="flex flex-col justify-center">
        <div className="p-12 rounded-3xl bg-gradient-to-br from-purple-500/20 to-fuchsia-500/10 border border-purple-500/30 space-y-10">
          <div className="space-y-4">
          ...
          {SLIDES.map((_, i) => (
            <button
              ...
              className={`w-2.5 h-2.5 rounded-full transition-colors ${
                i === current ? 'bg-purple-500' : 'bg-white/20 hover:bg-white/40'
              }`}
            />
          ))}
        </div>
