      ...
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-2xl mx-auto">
          {creators.map((creator, i) => (
            <div
              key={i}
              className="group relative rounded-2xl border border-border/60 bg-card/80 p-4 text-center backdrop-blur-sm transition-all hover:border-primary/40 hover:shadow-md"
            >
              ...
              {creator.location && (
                <p className="text-[10px] text-muted-foreground/70 mt-0.5 truncate">📍 {creator.location}</p>
              )}
