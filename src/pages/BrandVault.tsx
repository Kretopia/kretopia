...
export default function BrandVault() {
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <SEO title="Brand Vault · ThriveIN" description="Your persistent brand. Every deck, proposal and treatment Thrive generates inherits it." />
      ...
      <main className="max-w-3xl mx-auto px-4 py-5 space-y-5">
        <Card className="p-4 bg-gradient-to-br from-primary/5 via-card to-card border-primary/20">
          <p className="text-sm leading-relaxed text-foreground/85">
            ...
            treatment and rate card Thrive generates uses it automatically —
