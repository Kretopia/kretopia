          ...
          {user && !isLandingPage ? (
            ...
            <>
              ...
              <Sheet open={guestMenuOpen} onOpenChange={setGuestMenuOpen}>
                ...
                <SheetContent side="right" className="w-[80vw] sm:w-[320px]">
                  ...
                  <div className="flex flex-col gap-1 mt-6">
                    ...
                    <Button
                      variant="link"
                      className="btn-pink-gradient justify-start h-12 gap-2 text-sm font-semibold no-underline hover:no-underline"
              ...
              <Link to="/auth?tab=signup">
                <Button variant="link" size="sm" className="btn-pink-gradient gap-1.5 text-xs sm:text-sm px-2.5 sm:px-4 font-semibold no-underline hover:no-underline">
                  <Sparkles className="h-4 w-4" aria-hidden />
                  Get Started
                </Button>
              </Link>
